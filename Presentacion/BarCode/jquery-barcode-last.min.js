...
! function (g) {
    ...
    function m(r, t) {
        ...
        if (r = N(r, t), c = "101", "ean8" === t) {
            ...
            for (f = A[R(r.charAt(0))], e = 1; e < 7; e++) c += v[R(r.charAt(e))][R(f.charAt(e - 1))];
        ...
        if (c += "101", "ean13" === t)
            if (2 === (a = s.substring(13, s.length)).length)
                ...
                for (c += "0000000000", u = !0, n = o = 0, e = 0; e < 5; e++) u ? o += R(a.charAt(e)) : n += R(a.charAt(e)), u = !u;
                for (i = (9 * n + 3 * o) % 10, c += "1011", e = 0; e < 5; e++) h = R(a.charAt(e)), l = R(b[R(i)][e]), c += v[h][l], e < 4 && (c += "01")
            }
        return c
    }
    ...
    function y(r, t) {
        return "object" == typeof t ? ("mod10" === t.crc1 ? r = e(r) : "mod11" === t.crc1 && (r = n(r)), "mod10" === t.crc2 ? r = e(r) : "mod11" === t.crc2 && (r = n(r))) : "boolean" == typeof t && t && (r = e(r)), r
    }
    ...
    var H = function () {
        ...
        function X(r, t, e, n, o, a, i) {
            n < 0 && (n += a, o += 4 - (a + 4) % 8), o < 0 && (o += i, n += 4 - (i + 4) % 8), 1 !== t[n][o] && (r[n][o] = e, t[n][o] = 1)
        }
        return function (r, t) {
            var e, n = function (r) {
                var t, e, n = [],
    ...
    function R(r) {
        var t = typeof r;
        return "string" === t ? (r = r.replace(/[^0-9-.]/g, ""), r = parseInt(1 * r, 10), isNaN(r) || !isFinite(r) ? 0 : r) : "number" === t && isFinite(r) ? Math.floor(r) : 0
    }
    ...
    function O(r, t, e) {
        return String.fromCharCode(e) + String.fromCharCode(t) + String.fromCharCode(r)
    }
    ...
    function X(r) {
        for (var t, e, n, o, a, i, c, f = "", h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", l = 0; l < r.length;) o = (t = r.charCodeAt(l++)) >> 2, a = (3 & t) << 4 | (e = r.charCodeAt(l++)) >> 4, i = (15 & e) << 2 | (n = r.charCodeAt(l++)) >> 6, c = 63 & n, isNaN(e) ? i = c = 64 : isNaN(n) && (c = 64), f += h.charAt(o) + h.charAt(a) + h.charAt(i) + h.charAt(c);
        return f
    }

    function f(r) {
        var t, e = [];
        for (e[0] = [], t = 0; t < r.length; t++) e[0][t] = parseInt(r.charAt(t), 10);
        return e
    }

    function Y(r, t) {
        return r.css("padding", "0").css("overflow", "auto").css("width", t + "px").html(""), r
    }
    ...
    function i(r, t, e, n, o, a) {
        ...
        for (g = "BM" + z(54 + u, 4) + "\0\0\0\0" + z(54, 4) + z(40, 4) + z(o * A, 4) + z(a * v, 4) + z(1, 2) + z(24, 2) + "\0\0\0\0" + z(u, 4) + z(2835, 4) + z(2835, 4) + z(0, 4) + z(0, 4), c = v - 1; 0 <= c; c--) {
            for (s = "", f = 0; f < A; f++) s += e[c][f] ? N : m;
            for (s += W, h = 0; h < a; h++) g += s
        } (d = document.createElement("object")).setAttribute("type", "image/bmp"), d.setAttribute("data", "data:image/bmp;base64," + X(g)), Y(r, o * A + l).append(d)
    }
    ...
    g.fn.barcode = function (r, t, e) {
        ...
        if (n = (r = g.extend({
            ...
            h.length && (!u && e.addQuietZone && (h = "0000000000" + h + "0000000000"), (i = M[e.output + (u ? "2" : "")]) && this.each(function () {
                i(g(this), e, h, l)
            }))
        }
        return this
