...
public partial class CorrelativaConsultaCustom : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                #region PageIndex
                int PageIndex = 0;
                if (this.Session["CorrelativaConsultaCustom.PageIndex"] == null)
                {
                    Session.Add("CorrelativaConsultaCustom.PageIndex", 0);
                }
                else
                {
                    PageIndex = Convert.ToInt32(Session["CorrelativaConsultaCustom.PageIndex"]);
                }
                #endregion
                ...
                if (Request.QueryString["Id"] != null)
                {
                    ...
                    this.Master.TituloDelFormulario = " Correlativas de " + ocnEspacioCurricular.escNombre +  "- Consulta";
...
"</div>";
    ...
    protected void btnNuevo_Click(object sender, EventArgs e)
    {
	    try
	    {
            ...
            if (Request.QueryString["Id"] != null)
            {
                IdEC = Convert.ToInt32(Request.QueryString["Id"]);
            }
...
"</div>";
    ...
    private void GrillaCargar(int PageIndex)
    {
        try
        {
            Session["CorrelativaConsultaCustom.PageIndex"] = PageIndex;
            ...
            dt = new DataTable();
            dt = ocnCorrelativa.ObtenerTodoporEspacioCurricular(Id);
...
"</div>";
    ...
    protected void Grilla_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
	    try
	    {
            if (Session["CorrelativaConsultaCustom.PageIndex"] != null)
            {
                Session["CorrelativaConsultaCustom.PageIndex"] = e.NewPageIndex;
            }
            else
            {
                Session.Add("CorrelativaConsultaCustom.PageIndex", e.NewPageIndex);
            }
