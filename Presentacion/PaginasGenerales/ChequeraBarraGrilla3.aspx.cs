...
public partial class ChequeraBarraGrilla3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Label2_E1.Visible = false;
            Label2_E2.Visible = false;
            Label2_C2.Visible = false;
            lblApellidoNombre2.Visible = false;
            lblCurso2.Visible = false;
            lblCuota2.Visible = false;
            Label4_2.Visible = false;
            Label1_2.Visible = false;
            Label5_2.Visible = false;
            Label2_2.Visible = false;
            Label6_2.Visible = false;
            Label3_2.Visible = false;
            lblCodigoBarras2.Visible = false;

            lblApellidoNombre3.Visible = false;
            lblCurso3.Visible = false;
            lblCuota3.Visible = false;
            ...
            if (i == 2)
            {
                if(Convert.ToString(row["APELLIDOYNOMBRE"].ToString()) != "")
                {
                    Label2_E1.Visible = true;
                    Label2_E2.Visible = true;
                    Label2_C2.Visible = true;
                    lblApellidoNombre2.Visible = true;
                    lblCurso2.Visible = true;
                    lblCuota2.Visible = true;
                    Label4_2.Visible = true;
                    Label1_2.Visible = true;
                    Label5_2.Visible = true;
                    Label2_2.Visible = true;
                    Label6_2.Visible = true;
                    Label3_2.Visible = true;
                    lblCodigoBarras2.Visible = true;
                }
