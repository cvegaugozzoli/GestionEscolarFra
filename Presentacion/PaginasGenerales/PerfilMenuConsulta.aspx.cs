...
"</div>";
    ...
    protected void btnExportarAExcel_Click(object sender, EventArgs e)
    {
        ...
        string ArchivoNombre = "PerfilMenuConsulta_" + DateTime.Now.Day.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Year.ToString() + ".xls";
    ...
    protected void Grilla_RowCommand(object sender, GridViewCommandEventArgs e)
    {
	    try
	    {
		    if (e.CommandName != "Sort" && e.CommandName != "Page" && e.CommandName != "")
		    {
			    ...
			    {
				    ocnPerfilMenu = new GESTIONESCOLAR.Negocio.PerfilMenu(Convert.ToInt32(Id));
