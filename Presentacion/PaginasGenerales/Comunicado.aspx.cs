...
public partial class Comunicado : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                this.Master.TituloDelFormulario = "Comunicado";
                Session["Bandera"] = 0;
...
"</div>";
    ...
    private void GrillaBuscarCargar(int PageIndex)
    {
        try
        {
            ...
            {
                dt = ocnFamiliar.ObtenerTodoBuscarxNombre(TextBuscar.Text.Trim());
            ...
            {
                dt = ocnFamiliar.ObtenerUnoPorDocString(TextBuscar.Text.Trim());
                this.GrillaBuscar.DataSource = dt;
                this.GrillaBuscar.PageIndex = PageIndex;
                this.GrillaBuscar.DataBind();
            }
