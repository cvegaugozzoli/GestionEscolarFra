<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="MovimientoRepite.aspx.cs" Inherits="MovimientoRepite" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    <div class="row">
        <div class="form-group">
            ...
            <br />            <asp:Label ID="lblMensajeError" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#CC0000"></asp:Label>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label runat="server" id="lblNivel" class="control-label">Nivel/Carrera</label>
     ...
     <div id="alerRepiteCurso" visible="false" runat="server" class="alert alert-info  alert-dismissable">
