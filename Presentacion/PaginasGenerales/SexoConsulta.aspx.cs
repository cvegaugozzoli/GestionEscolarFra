...
public partial class SexoConsulta : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                this.Master.TituloDelFormulario = " Sexo - Consulta";
...
"</div>";
    ...
    protected void btnNuevo_Click(object sender, EventArgs e)
    {
	    try
	    {
            Response.Redirect("SexoRegistracion.aspx?Id=0", false);
	    }
	    catch (Exception oError)
	    {
            lblMensajeError.Text = @"<div class=""alert alert-danger alert-dismissable"">
...
"</div>";
    ...
    {
        dt = new DataTable();
        dt = ocnSexo.ObtenerTodoBuscarxNombre(Nombre.Text.Trim());
        string ArchivoNombre = "SexoConsulta_" + DateTime.Now.Day.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Year.ToString() + ".xls";
    ...
    private void GrillaCargar(int PageIndex)
    {
        try
        {
            Session["SexoConsulta.PageIndex"] = PageIndex;
...
"</div>";
    ...
    protected void Grilla_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
	    try
	    {
            if (Session["SexoConsulta.PageIndex"] != null)
            {
                Session["SexoConsulta.PageIndex"] = e.NewPageIndex;
            }
            else
            {
                Session.Add("SexoConsulta.PageIndex", e.NewPageIndex);
            }
