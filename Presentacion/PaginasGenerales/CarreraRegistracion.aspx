<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="CarreraRegistracion.aspx.cs" Inherits="CarreraRegistracion" %>
	    ...
	    <div class="col-sm-12">
		    <div class="ibox-content">
			    <fieldset class="form-horizontal">				   
                        ...
                        <asp:TextBox ID="carNombre" Height="50px" required="" type="text" class="form-control" runat="server"></asp:TextBox></div></div>
                       <label class="control-label col-md-2">Tipo</label>
                        <div class="col-md-3">
                            <asp:DropDownList ID="TipoCarrera" BorderColor="Silver" runat="server" class="form-control m-b" Enabled="true"></asp:DropDownList>
                        </div>
                      <div class="form-group"><label class="control-label col-md-2"> Activo</label><div class="col-md-6">
                        <asp:CheckBox ID="carActivo" runat="server" Checked="True" Enabled="true"></asp:CheckBox></div></div>
