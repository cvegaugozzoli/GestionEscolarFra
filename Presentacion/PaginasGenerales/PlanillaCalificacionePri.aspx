<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="PlanillaCalificacionePri.aspx.cs" Inherits="PlanillaCalificacionePri" %>
            ...
            <div id="dvGrid" style="padding: 10px; width: 550px">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" GridLines="Horizontal" CssClass="table table-striped" AutoGenerateColumns="true" OnRowDataBound="GridView1_RowDataBound"
                            PageSize="50" AllowPaging="true" OnRowEditing="OnRowEditing" OnRowUpdating="OnRowUpdating" HeaderStyle="90"
