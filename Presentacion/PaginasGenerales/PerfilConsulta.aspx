                    ...
                    <asp:GridView ID="Grilla" runat="server" GridLines="None" CssClass="table table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Descripcion">
                                <ItemTemplate>
                                    <asp:HyperLink ForeColor="Black" ID="Descripcion" runat="server" NavigateUrl='<%# "PerfilRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("Descripcion") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
