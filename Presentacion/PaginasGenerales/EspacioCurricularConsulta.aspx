        ...
        <div class="col-sm-12">
            <div class="ibox-content">
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnCorrelativas" Visible="false" class="btn btn-w-m btn-primary" runat="server" Text="Correlativas" OnClick="btnCorrelativas_Click" Width="100%" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    <asp:GridView ID="Grilla" runat="server" GridLines="None" CssClass="table table-striped" OnRowEditing="OnRowEditing"
                        AutoGenerateColumns="False"  DataKeyNames="Id" OnRowDataBound="OnRowDataBound" OnRowCommand="Grilla_RowCommand"  OnRowUpdating="OnRowUpdating" AllowPaging="True" OnPageIndexChanging="Grilla_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Orden" ItemStyle-Width="80">
                                <ItemTemplate>
                                    <asp:Label ID="Orden" runat="server" Text='<%# Eval("Orden") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="80px" />
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtOrden" runat="server" Text='<%# Eval("Orden") %>' Width="90"></asp:TextBox>
                                </EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Correlativas">
                                ...
                                <asp:CommandField  HeaderText="Modificar Orden" ButtonType="Link" ShowEditButton="true" ShowCancelButton="false"
                                    ItemStyle-Width="80" >
