<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master"
    AutoEventWireup="true" CodeFile="Recaudacion.aspx.cs" Inherits="Recaudacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
      ...
      <div class="row">
            ...
            <div class="form-group col-md-2">
             ...
             <div class="col-md-2">
                ...
                <asp:TextBox ID="icuAnioCursado" type="number" BorderColor="Silver" step="1" class="form-control" runat="server" AutoPostBack="True"></asp:TextBox>
            </div>
            <div class="form-group col-md-5">
                <br />
                <label>Incluir Usuarios&nbsp;&nbsp;&nbsp;</label>
                <asp:RadioButtonList AutoPostBack="true" CssClass="form-check form-check-inline" RepeatLayout="Flow" ID="RbtUsuarios" runat="server" RepeatDirection="Horizontal" Font-Bold="True" Font-Italic="False">
                    <asp:ListItem style="margin-left: 0px; font-weight: bold" Selected="True" Value="0">Logueado</asp:ListItem>
                    <asp:ListItem style="margin-left: 30px; font-weight: bold" Value="1">Todos</asp:ListItem>
                </asp:RadioButtonList>
            </div>
        </div>
    ...
    <div class="row">
        <div class="ibox-content">
            <div class="form-group">
                <h3>Listar<asp:Label ID="Label1" runat="server" Text=""></asp:Label></h3>
                <asp:Button ID="btnImprimir" class="btn btn-w-m btn-primary" runat="server" Text="Detalle" Visible="true" OnClick="btnImprimir_Click" />
                &nbsp;
                <asp:Button ID="btnResumen" class="btn btn-w-m btn-primary" runat="server" Text="Resúmen Gral." Visible="true" OnClick="btnResumen_Click" />
                &nbsp;
