                    ...
                    <asp:GridView ID="Grilla" runat="server" GridLines="None" CssClass="table table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="EspacioCurricular Original">
                                <ItemTemplate>
                                    <asp:HyperLink ForeColor="Black" ID="EspacioCurricular" runat="server" NavigateUrl='<%# "CorrelativaRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("EspacioCurricular Original") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
