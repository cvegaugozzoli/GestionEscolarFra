<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChequeraBarraGrilla4.aspx.cs" Inherits="ChequeraBarraGrilla4" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div id="barcode">
                        <asp:Label ID="lblCodigoBarras" Visible ="false" runat="server"></asp:Label>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group col-md-12">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-10">
                                <asp:Label ID="Label2_E1" runat="server" Text="Inst. Madre Mercedes Guerra. " Font-Bold="True" Font-Size="Small"> </asp:Label>
                                <br />
                                <asp:Label ID="Label2_E2" runat="server" Text="Hnas. Terc. Franciscanas de la caridad
                            Incorporado a la enseñanza oficial
                            CUIT: 3063012583-5 IVA EXENTO"
                                    Font-Bold="True" Font-Size="x-Small"> </asp:Label>
                            </div>
                        ...
                        <div class="form-row">
                            <asp:Label ID="Label2_C2" Text="Cuota: " runat="server"></asp:Label>
        ...
        <link href="../cssFranciscana/css/bootstrap.min.css" rel="stylesheet" />
        <script src="../cssFranciscana/js/jquery-1.5.2.min.js"></script>
        <script src="../cssFranciscana/css/bootstrap.min.js"></script>

        <!-- jsPDF library -->
        <script src="..js/jsPDF-master/src/jspdf.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            // Save the PDF
           // doc.saveAs('/c/Aplicativos/GestionEscolarFra/chequera.pdf');
