                ...
                <div class="table-responsive">
                    <asp:GridView ID="Grilla" runat="server" GridLines="None" CssClass="table table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="AnoCursado">
                                <ItemTemplate>
                                    <asp:HyperLink ForeColor="Black" ID="AnoCursado" runat="server" NavigateUrl='<%# "UsuarioEspacioCurricularRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("AnoCursado") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="PlanEstudio">
                                <ItemTemplate>
                                    <asp:HyperLink ForeColor="Black" ID="PlanEstudio" runat="server" NavigateUrl='<%# "UsuarioEspacioCurricularRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("PlanEstudio") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
