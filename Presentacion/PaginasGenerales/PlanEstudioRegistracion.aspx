<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="PlanEstudioRegistracion.aspx.cs" Inherits="PlanEstudioRegistracion" %>
	    ...
	    <div class="col-sm-12">
		    <div class="ibox-content">
			    <fieldset class="form-horizontal">				   
                        ...
                        <asp:TextBox ID="plaNombre" Height="50px" TextMode="MultiLine" type="text" class="form-control" runat="server"></asp:TextBox></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Ano Inicio Vigencia</label><div class="col-md-6">
                        <asp:TextBox ID="plaAnoInicioVigencia" type="number" step="1" class="form-control" runat="server"></asp:TextBox></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Ano Fin Vigencia</label><div class="col-md-6">
                        <asp:TextBox ID="plaAnoFinVigencia" type="number" step="1" class="form-control" runat="server"></asp:TextBox></div></div>
                        ...
                        <asp:CheckBox ID="plaActivo" runat="server" Checked="True" Enabled="true"></asp:CheckBox></div></div>
