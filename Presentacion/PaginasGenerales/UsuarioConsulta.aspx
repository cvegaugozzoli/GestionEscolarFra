                ...
                <div class="table-responsive"><asp:GridView ID="Grilla" runat="server" GridLines="None" CssClass="table table-striped"
	                ...
	                <Columns>
                        ...
                        <asp:TemplateField HeaderText="Clave">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="Clave" runat="server" NavigateUrl='<%# "UsuarioRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("Clave") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ClaveProvisoria">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="ClaveProvisoria" runat="server" NavigateUrl='<%# "UsuarioRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("ClaveProvisoria") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="CambiarClave">
                            <ItemTemplate>
                                <asp:HyperLink ForeColor="Black" ID="CambiarClave" runat="server" NavigateUrl='<%# "UsuarioRegistracion.aspx?Id=" + DataBinder.Eval(Container.DataItem,"Id").ToString() %>' Text='<%# Eval("CambiarClave") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
