<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="CampoRegistracion.aspx.cs" Inherits="CampoRegistracion" %>
	    ...
	    <div class="col-sm-12">
		    <div class="ibox-content">
			    <fieldset class="form-horizontal">				   
                        ...
                        <asp:TextBox ID="camNombre" Height="50px" TextMode="MultiLine" type="text" class="form-control" runat="server"></asp:TextBox></div></div>
                        ...
                        <asp:CheckBox ID="camActivo" runat="server" Checked="True" Enabled="true"></asp:CheckBox></div></div>
