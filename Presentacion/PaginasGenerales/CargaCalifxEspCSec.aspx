                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" GridLines="None" CssClass="table table-striped" AutoGenerateColumns="False" OnRowDataBound="OnRowDataBound"
                            DataKeyNames="Id" PageSize="50" AllowPaging="true" OnRowEditing="OnRowEditing" OnRowUpdating="OnRowUpdating"
                            Width="100%" BorderColor="#3399FF" HorizontalAlign="Center">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Primer Cuatrimestre" ItemStyle-Width="100">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Segundo Cuatrimestre" ItemStyle-Width="100">
                                    <ItemTemplate>
