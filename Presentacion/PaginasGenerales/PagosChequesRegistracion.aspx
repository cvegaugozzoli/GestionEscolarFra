<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="PagosChequesRegistracion.aspx.cs" Inherits="PagosChequesRegistracion" %>
	    ...
	    <div class="col-sm-12">
		    <div class="ibox-content">
			    <fieldset class="form-horizontal">				   
                        ...
                        <asp:TextBox ID="pchImporte" type="number" step="0.1" class="form-control" runat="server"></asp:TextBox></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Cheque Nro</label><div class="col-md-6">
                        <asp:TextBox ID="pchChequeNro" type="text" class="form-control" runat="server"></asp:TextBox></div></div>
                        ...
                        <asp:CheckBox ID="pchActivo" runat="server" Checked="True" Enabled="true"></asp:CheckBox></div></div>
