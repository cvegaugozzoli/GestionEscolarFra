<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="ComprobantesPtosVtaRegistracion.aspx.cs" Inherits="ComprobantesPtosVtaRegistracion" %>
	    ...
	    <div class="col-sm-12">
		    <div class="ibox-content">
			    <fieldset class="form-horizontal">				   
                        ...
                        <div class="form-group"><label class="control-label col-md-2"> Pto Vta</label><div class="col-md-6">
                        <asp:TextBox ID="cpvPtoVta" type="text" class="form-control" runat="server"></asp:TextBox></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Ultimo Nro</label><div class="col-md-6">
                        <asp:TextBox ID="cpvUltimoNro" type="number" step="1" class="form-control" runat="server"></asp:TextBox></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Comprobantes Destinos</label><div class="col-md-6">
                        <asp:DropDownList ID="cdoId" runat="server" class="form-control m-b" Enabled="true"></asp:DropDownList></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Activo</label><div class="col-md-6">
                        <asp:CheckBox ID="cpvActivo" runat="server" Checked="True" Enabled="true"></asp:CheckBox></div></div>
