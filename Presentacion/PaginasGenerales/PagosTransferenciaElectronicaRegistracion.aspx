<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="PagosTransferenciaElectronicaRegistracion.aspx.cs" Inherits="PagosTransferenciaElectronicaRegistracion" %>
	    ...
	    <div class="col-sm-12">
		    <div class="ibox-content">
			    <fieldset class="form-horizontal">				   
                        ...
                        <asp:TextBox ID="pteImporte" type="number" step="0.1" class="form-control" runat="server"></asp:TextBox></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Nro Cuenta</label><div class="col-md-6">
                        <asp:TextBox ID="pteNroCuenta" type="text" class="form-control" runat="server"></asp:TextBox></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Bancos</label><div class="col-md-6">
                        <asp:DropDownList ID="banId" runat="server" class="form-control m-b" Enabled="true"></asp:DropDownList></div></div>
                        <div class="form-group"><label class="control-label col-md-2"> Activo</label><div class="col-md-6">
                        <asp:CheckBox ID="pteActivo" runat="server" Checked="True" Enabled="true"></asp:CheckBox></div></div>
