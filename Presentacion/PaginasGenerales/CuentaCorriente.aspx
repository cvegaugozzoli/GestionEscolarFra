<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="CuentaCorriente.aspx.cs" Inherits="CuentaCorriente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-content">
                <div class="table-responsive">
                    <asp:GridView ID="GrillaHistorial" runat="server" DataKeyNames="icoId,RA,cntId,conId,TipoConcepto,Concepto,Importe,ImporteInteres,AnioLectivo,Beca,BecId,NroCuota,FchInscripcion,insId,FechaVto,ImpPagado,FechaPago,NroCompbte,Curso,LP,FP" GridLines="None" CssClass="table table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ImporteInteres" HeaderText="Interés" Visible="true" />
                            <asp:BoundField DataField="RA" HeaderText="RA" Visible="false" />
    ...
    <div class="row">
        <div class="ibox-content">
            <div class="form-inline">
                ...
                <div class="form-group col-md-2">
                    <asp:Button ID="btnImprimir2" class="btn btn-w-m btn-warning" runat="server" Text="Imprimir" Visible="true" OnClick="btnImprimirClick" Width="100%" />
                </div>
