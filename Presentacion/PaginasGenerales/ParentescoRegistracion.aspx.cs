...
public partial class ParentescoRegistracion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                this.Master.TituloDelFormulario = " Parentesco - Registracion";
                ...
                if (Request.QueryString["Id"] != null)
                {
					...
					if (Id != 0)
                    {
                        ocnParentesco = new GESTIONESCOLAR.Negocio.Parentesco(Id);
						this.parDescripcion.Text = ocnParentesco.patDescripcion;
	...
	protected void btnAceptar_Click(object sender, EventArgs e)
	{
        try
        {
		    ...
		    if (Request.QueryString["Id"] != null)
		    {
                ...
                ocnParentesco.patDescripcion = parDescripcion.Text;
                //ocnParentesco.sexActivo = sexActivo.Checked; 
                ...
                if (MensajeValidacion.Trim().Length == 0)
			    {
				    ...
				    else
				    {
                        ...
                        //ocnSexo.sexFechaHoraUltimaModificacion = DateTime.Now;
                        //ocnSexo.usuIdUltimaModificacion = this.Master.usuId;
                        ocnParentesco.Actualizar();
				    }
					
				    Response.Redirect("ParentescoConsulta.aspx", true);
			    }
			    else
			    {
