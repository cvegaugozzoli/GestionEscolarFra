<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="Comunicado.aspx.cs" Inherits="Comunicado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
    ...
    <label class="control-label col-md-10">Busqueda del Familiar</label>
        ...
        <div class="col-sm-8">
            <div class="form-inline">
                ...
                <div class="col-md-8">
                    ...
                    <asp:Button ID="btnCancelarAlumno" formnovalidate="formnovalidate " class="btn btn-w-m btn-danger" runat="server" Text="Cancelar" OnClick="btnCancelar2_Click" />
                        ...
                        <asp:GridView ID="GrillaBuscar" runat="server" GridLines="None" CssClass="table table-striped"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="DNI">
                                    <ItemTemplate>
                                        <asp:HyperLink ForeColor="Black" CommandName="Select" ID="DNI" runat="server" Text='<%# Eval("Doc") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Mail">
                                    <ItemTemplate>
                                        <asp:HyperLink ForeColor="Black" CommandName="Select" ID="Mail" runat="server" Text='<%# Eval("Mail") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
