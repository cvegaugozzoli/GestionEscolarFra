<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="MovimientoPromocionar.aspx.cs" Inherits="MovimientoPromocionar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label runat="server" class="control-label">Colegio</label>
                            <asp:DropDownList ID="colegioId" placeholder="Carrera" runat="server" BorderColor="Silver" class="form-control" Enabled="true" AutoPostBack="true" OnSelectedIndexChanged="colegioId_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                         <div class="form-group col-md-4">
                ...
                <asp:DropDownList ID="NivelID" runat="server" BorderColor="Silver" class="form-control" Enabled="true" AutoPostBack="True" OnSelectedIndexChanged="NivelID_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <asp:TextBox ID="AnioCursado" type="text" class="form-control" BorderColor="Silver" runat="server" placeholder="" AutoPostBack="true" OnTextChanged="AnioCursado_TextChanged"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4">
        ...
        <div class="col-md-6">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label runat="server" id="lblColegio" class="control-label">Colegio</label>
                            <asp:DropDownList ID="colegioId2" placeholder="Carrera" runat="server" BorderColor="Silver" class="form-control" Enabled="true" AutoPostBack="true" OnSelectedIndexChanged="colegioId2_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                         <div class="form-group col-md-4">
                <label class="control-label" runat="server" id="lblNivel" >Nivel</label>
                <asp:DropDownList ID="NivelID2" runat="server" BorderColor="Silver" class="form-control" Enabled="true" AutoPostBack="True" OnSelectedIndexChanged="NivelID2_SelectedIndexChanged"></asp:DropDownList>
            </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <asp:TextBox ID="AnioCursado2" type="text" class="form-control" BorderColor="Silver" runat="server" placeholder="" AutoPostBack="true" OnTextChanged="AnioCursado2_TextChanged"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-4">
    ...
    <div id="alerPromociona" visible="false" runat="server" class="alert alert-info  alert-dismissable">
        <h5 style="font-weight: bold; font-size: medium">"Se registró con exito la acción.."</h5>
    </div>
         <div id="alerPromociona2" visible="false" runat="server" class="alert alert-info  alert-dismissable">
        <h5 style="font-weight: bold; font-size: medium">"Solo se promocionaron los alumnos que cumplen requisitos de cuotas.."</h5>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <asp:GridView ID="GrillaAlumnos2" runat="server" DataKeyNames="IC,Nombre,DNI,aluId,Estado" GridLines="None" CssClass="table table-striped"
                ...
                <PagerStyle HorizontalAlign="Center" CssClass="GridPager" />
                <Columns>
                    <asp:BoundField DataField="IC" HeaderText="IC" Visible="false" />
