...
public partial class Recaudacion : System.Web.UI.Page
{
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void btnImprimir_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //}
            if (RbtUsuarios.SelectedValue == "0")
            {
                RecauxUsu2 = Master.usuId;
            }

            int AnoCursado = 0;
            if (icuAnioCursado.Text.Trim() == "")
            {
                icuAnioCursado.Text = "0";
            }
            AnoCursado = Convert.ToInt32(icuAnioCursado.Text.Trim());


            NomRep = "ListadoRecaudacionporUsuarioporAnio.rpt";
            FuncionesUtiles.AbreVentana("Reporte.aspx?insId=" + insId + "&desde=" + desde + "&hasta=" + hasta + "&RecauxUsu=" + RecauxUsu2 + "&aniocursado=" + AnoCursado + "&NomRep=" + NomRep);
            ...
            //NomRep = "ListadoRecaudacionporUsuarioporAnio.rpt";
            //FuncionesUtiles.AbreVentana("Reporte.aspx?insId=" + insId + "&desde=" + desde + "&hasta=" + hasta + "&RecauxUsu=" + RecauxUsu + "&aniocursado=" + AnoCursado + "&NomRep=" + NomRep);
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void btnResumen_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            NomRep = "ListadoRecaudacionporUsuarioporAnioResumen.rpt";
