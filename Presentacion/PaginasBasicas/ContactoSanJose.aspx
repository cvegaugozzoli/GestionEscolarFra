<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContactoSanJose.aspx.cs" Inherits="ContactoSanJose" %>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form runat="server" class="contact100-form validate-form">
                ...
                <label class="label-input100" for="phone">Nivel</label>
                <div class="wrap-input100">
                    <div class="input100">

                        <asp:DropDownList ID="ddlNivel" runat="server" BorderColor="Silver" BorderStyle="Solid" Enabled="true" CssClass="dropdown-item">
                                                        <asp:ListItem Value="-1" Selected="True">Seleccionar..</asp:ListItem>
                ...
                <div class="wrap-input100 rs2-wrap-input100 " >
                    <asp:LinkButton ID="btnCancelar" runat="server" OnClick="btnCancelar_Click" formnovalidate="formnovalidate " class="contact100-form-btn"><i class="fa fa-home fa-2x"></i>&nbsp;Inicio</asp:LinkButton>
                    <span class="focus-input100"></span>
                </div>
            ...
            <div class="contact100-more flex-col-c-m" style="background-image: url('images/bg-01.jpg');">
                <span class="contact100-form-title" style="color: #FFFFFF">Colegio San José</span>
                <div class="flex-w size1 p-b-47">
                    ...
                    <div class="flex-col size2">
                        ...
                        <span class="txt2">Libertad 341. Santiago del Estero.
                        </span>
                    </div>
                </div>
                ...
                <div class="dis-flex size1 p-b-47">
                    ...
                    <div class="flex-col size2">
                        ...
                        <span class="txt3">0385-4211579 / 4240161  </span>
                    </div>
                </div>
                ...
                <div class="dis-flex size1 p-b-47">
                    ...
                    <div class="flex-col size2">
                        <span class="txt1 p-b-20">Internos
                        </span>
                        <span class="txt3">Primaria 113</span>
                        <span class="txt3">Secundaria 129</span>
                        <span class="txt3">Superior 126</span>
                    </div>
                </div>
            ...
            <div class="dis-flex size1 p-b-47">
                ...
                <div class="flex-col size2">
                    ...
                    <span class="txt3">secretariaprimaria@sanjosesgo.edu.ar
                    </span><span class="txt3">secretariasecundaria@sanjosesgo.edu.ar
                    </span><span class="txt3">secretariasuperior@sanjosesgo.edu.ar
                    </span>
                </div>
            </div>
        </div>
